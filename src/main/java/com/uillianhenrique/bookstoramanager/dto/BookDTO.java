...
import com.uillianhenrique.bookstoramanager.entity.Author;
...
public class BookDTO {
    ...
    @NotNull(message = "Ops! inform the number of pages")
    private Integer pages;

    @NotNull(message = "Ops! inform the number of chapters")
